...
const ProfilePage = () => {
  ...
  const handleImageChange = (e) => {
    ...
    if(file){
      ...
      reader.onloadend = () => {
        setImage(reader.result); //render.result - base64 string
      };

      reader.readAsDataURL(file); //format za prikazivanje slike u <img src="..." />
    }
  }
    ...
    <div className='min-h-screen bg-gray-50 flex flex-col'>
      ...
      <div className='flex-grow flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mt-8 sm:mx-auto sm:w-full sm:max-w-md'>
          <div className='bg-white py-8 mx-4 shadow sm:rounded-lg sm:px-10 border border-gray-200'>
              ...
              <div>
                ...
                <div className='mt-1'>
                  <input 
                    ...
                    className='apperance-none block w-full px-3 py-2 border border-gray-300
              ...
              <div>
                ...
                <div className="mt-1">
                  <input 
                    ...
                    className='apperance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm
              ...
              <div>
                  ...
                  <div className='mt-1'>
                    <textarea 
                      ...
                      className = "apperance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-pink-500 focus:border-pink-500 sm:text-sm"
                    />
                  </div>
              </div>
