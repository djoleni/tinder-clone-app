    ...
    <>
        ...
        <div className='flex flex-col h-full'>
            ...
            <div className="p-4 pb-[27px] border-b border-pink-200 flex justify-between items-center">
                ...
                <button className="lg:hidden p-1 text-gray-500 hover:text-gray-700 focus:outline-none"
            ...
            {isLoadingMyMatches ? <LoadingState/> 
                    : matches.length === 0 
                    ? <NoMatchesFound/> 
                    : (
                        matches.map(match=> (
        ...
        <button className="lg:hidden fixed top-4 left-4 p-2 bg-pink-500 text-white rounded-md z-0 cursor-pointer"
            onClick={toggleSidebar}
        >
