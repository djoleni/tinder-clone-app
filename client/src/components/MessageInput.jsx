  ...
  return (
    <form onSubmit={handleSendMessage} className='flex relative'>
        ...
        <input 
            ...
            className='flex-grow p-3 pl-12 rounded-l-lg border-2 
            border-pink-500 focus:outline-none focus:ring-2 focus:ring-pink-300'
        ...
        <button
            ...
            hover:bg-pink-600 transition-colors focus:outline-none focus:ring-2 
            focus:ring-pink-300'    
        >
            <Send size={24}/>
        </button>
